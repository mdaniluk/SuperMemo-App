...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Schedule_t, stringdata) + ofs \
...
const QMetaObject Schedule::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Schedule.data,
      qt_meta_data_Schedule,  qt_static_metacall, 0, 0}
};
...
void *Schedule::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Schedule"))
        return static_cast< Ui::Schedule*>(const_cast< Schedule*>(this));
