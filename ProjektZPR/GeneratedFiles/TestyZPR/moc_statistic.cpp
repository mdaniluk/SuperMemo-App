...
QT_MOC_LITERAL(3, 25, 11)
    ...
    "Statistic\0showStatistic\0\0vector<int>\0"
};
...
void Statistic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showStatistic((*reinterpret_cast< vector<int>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *Statistic::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Statistic"))
        return static_cast< Ui::Statistic*>(const_cast< Statistic*>(this));
